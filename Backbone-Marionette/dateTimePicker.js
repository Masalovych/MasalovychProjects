define([
	//'text!templates/tasks/settingsHeader/timePicker.html',
	'text!templates/calendar/dateTimePicker.html',
	'text!templates/tasks/settingsHeader/reminder.html',
	'models/remainder',
	'custom'
],
    function (timePickerTemplate, ReminderTemplate, RemainderModel, custom) {
        'use strict';
        ...
        var View = Backbone.Marionette.ItemView.extend({
            ...
            changeEventDate: function(){
				...
				var self = this;
//				var expandedTask = $('#task_list_ul').find('li.on');
//                var taskId = expandedTask.attr('id');

				var date = this.$el.find(".picker").datepicker('getDate');
				date = new Date(date);
				var hours = parseInt(this.$el.find(".hours").val());
            ...
            editReminders:function(e){
                ...
                input.datepicker({
                    ...
                    onSelect: function(){
                        ...
                        var taskId = reminderLi.attr('remindable_id');

                        var date = input.datepicker('getDate');

                        var model = new RemainderModel();
                        ...
                        model.save({id: reminderId, datetime: new Date(date)}, {
                            ...
                            error: function(coll){console.log(" error save reminder")}
                        });
            ...
            destroyReminder: function(e){
                ...
                model.destroy({
                    success: function(){
                        $('#reminders li#' + reminderId).remove();
                    },
